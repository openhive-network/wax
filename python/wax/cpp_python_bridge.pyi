...
def op_to_json(wax_op: python_operation_handle) -> bytes: ...
...
def tx_to_binary(
    tx: python_transaction_handle, use_hf26_serialization: bool, strip_to_unsigned_transaction: bool
) -> bytes: ...
...
def encode_encrypted_memo(
    encrypted_content: bytes, main_encryption_key: bytes, other_encryption_key: bytes = b""
...
def deserialize_witness_set_properties(
    serialized_properties: dict[bytes, bytes],
) -> python_witness_set_properties_data: ...
...
def minimize_required_signatures(
    signed_transaction: bytes, minimize_required_signatures_data: python_minimize_required_signatures_data
) -> list[bytes]: ...
...
def check_memo_for_private_keys(
    memo: bytes, account: bytes, auths: python_authorities, memo_key: bytes, imported_keys: list[bytes] = []
) -> None: ...
