...
def tx_signature_keys(tx: python_transaction_handle, chain_id: str, use_hf26_serialization: bool) -> list[bytes]: ...
def tx_sig_digest(tx: python_transaction_handle, chain_id: str, use_hf26_serialization: bool) -> bytes: ...
