...
EXPECTED_OPERATION_IMPACTED_ACCOUNTS: Final[list[str]] = [
    ...
    PROTO_REF_VOTE_OP["vote_operation"]["voter"],  # type: ignore[list-item]
]

EXPECTED_TRANSACTION_IMPACTED_ACCOUNTS: Final[list[str]] = [
    PROTO_REF_TRANSACTION["operations"][0]["vote_operation"]["author"],  # type: ignore[index]
    PROTO_REF_TRANSACTION["operations"][0]["vote_operation"]["voter"],  # type: ignore[index]
]
