...
class fill_recurrent_transfer(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["amount", b"amount", "extensions", b"extensions", "from_account", b"from_account", "memo", b"memo", "remaining_executions", b"remaining_executions", "to_account", b"to_account"]) -> None: ...
