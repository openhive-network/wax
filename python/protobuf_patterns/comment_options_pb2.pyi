...
class comment_options_extension(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["comment_payout_beneficiaries", b"comment_payout_beneficiaries", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["comment_payout_beneficiaries", b"comment_payout_beneficiaries", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value", b"value"]) -> typing_extensions.Literal["comment_payout_beneficiaries"] | None: ...
