...
class failed_recurrent_transfer(google.protobuf.message.Message):
    ...
    def extensions(
        ...
        recurrent_transfer_extension_pb2.recurrent_transfer_extension
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        extensions: collections.abc.Iterable[recurrent_transfer_extension_pb2.recurrent_transfer_extension]
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
