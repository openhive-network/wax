...
class witness_set_properties(google.protobuf.message.Message):
    ...
    def extensions(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[future_extensions_pb2.future_extensions]:
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["extensions", b"extensions", "owner", b"owner", "props", b"props"]
    ) -> None: ...
