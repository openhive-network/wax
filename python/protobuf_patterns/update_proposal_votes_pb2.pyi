...
class update_proposal_votes(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["approve", b"approve", "voter", b"voter"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "approve", b"approve", "extensions", b"extensions", "proposal_ids", b"proposal_ids", "voter", b"voter"
        ],
    ) -> None: ...
