...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 6, 31, 1, "", "account_update2.proto")
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_ACCOUNT_UPDATE2"]._serialized_end = 501
