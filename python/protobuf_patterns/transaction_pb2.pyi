...
class transaction(google.protobuf.message.Message):
    ...
    def operations(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[operation_pb2.operation]: ...
    @property
    def extensions(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        future_extensions_pb2.future_extensions
    ]: ...
    @property
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            "expiration", b"expiration", "ref_block_num", b"ref_block_num", "ref_block_prefix", b"ref_block_prefix"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
