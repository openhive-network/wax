...
class claim_account(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["creator", b"creator", "fee", b"fee"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["creator", b"creator", "extensions", b"extensions", "fee", b"fee"]
    ) -> None: ...
