...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 6, 31, 1, "", "pow2.proto")
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_POW2"]._serialized_end = 869
