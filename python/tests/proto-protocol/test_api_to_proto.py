...
def test_api_to_proto():
    ...
    assert proto.result.decode() == json.dumps(PROTO_REF_TRANSACTION, separators=(',', ':')), "Converted proto should match reference"
    ...
    assert proto.result.decode() == json.dumps(PROTO_REF_RELEASE_BLOCK, separators=(',', ':')), "Converted release block should match reference"
