...
def test_calculate_sig_digest_positive():
    ...
    # Act
    result = calculate_sig_digest(
        transaction=tx_str.encode(), chain_id=b"beeab0de00000000000000000000000000000000000000000000000000000000"
    )
    ...
    assert result.result == b"b31ff450905ad705ed0d7fd5e270c3685442203e15e1b1e7d5e94b35dcdc1693", (
        "Sig digest should match expected value"
    )
...
def test_calculate_legacy_serialization_sensitive_sig_digest():
    ...
    # Act
    result = calculate_legacy_sig_digest(
        tx_str.encode(), b"beeab0de00000000000000000000000000000000000000000000000000000000"
    )
    ...
    assert result.result == b"7fbd09ff2c3a90acfc59adce5abffdaa3fc95e33160c5ac237f0f4366f90e2fe", (
        "Legacy sig digest should differ from standard"
    )
