...
PROTO_REF_VOTE_OP: dict[str, dict[str, str | int]] = {
    "vote_operation": {"voter": "otom", "author": "c0ff33a", "permlink": "ewxhnjbj", "weight": 2200}
}

PROTO_REF_VOTE_OP_EMPTY: dict[str, dict[str, Any]] = {"vote_operation": {}}
...
PROTO_REF_HF_BLOCK = {
    ...
    "extensions": [
        {"version": "0.20.0"},
        {"hardfork_version_vote": {"hf_time": "2018-09-25T15:00:00", "hf_version": "0.20.0"}},
    ],
            ...
            "operations": [
                {
                    "transfer_operation": {
                        "from": "buildawhale",
                        "to": "just-smile",
                        "amount": {"nai": "@@000000021", "precision": 3, "amount": "357000"},
...
API_REF_VOTE_OP_EMPTY = {"type": "vote_operation", "value": {}}
...
API_LEGACY_REF_SERIALIZATION_SENSITIVE_TRANSACTION = {
    ...
    "operations": [
        [
            "transfer",
            {"from": "oneplus7", "to": "kryptogames", "amount": "300.000 HIVE", "memo": "Roll under 50 4d434bd943616"},
        ]
    ],
    "extensions": [],
    "signatures": [],
...
API_REF_RELEASE_BLOCK = {
    "block_id": "000f424ceba45f761f7af77e3769f29309064606",
    "extensions": [{"type": "version", "value": "1.27.4"}],
    "previous": "000f424b4e3f3a6069ef7ff86e39ca43628208ad",
    "signing_key": "STM7xxob4v4X99qiBNpwpd6rTFqh2JpXER9DC4EYqr8rAH8J2QUMR",
    "timestamp": "2016-04-29T04:12:36",
    "transaction_ids": ["5ab7fb8138ef8f701661d68f7d654df5f8e2fcfc"],
...
API_REF_HF_BLOCK = {
    "block_id": "018ca4f6465b584e528fa6f18465cc30d9d02dc2",
    "extensions": [
        {"type": "version", "value": "0.20.0"},
        {"type": "hardfork_version_vote", "value": {"hf_time": "2018-09-25T15:00:00", "hf_version": "0.20.0"}},
    ],
    "previous": "018ca4f536a6dff7701e10dbb659f406acd27f38",
    "signing_key": "STM7HrgGgxhCNbhjyJ8jbcwVdGx3ifMJkX3QVmGDPXyR5PNKmR94i",
    "timestamp": "2018-09-15T23:18:30",
