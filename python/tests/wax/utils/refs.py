...
ACCOUNT_AUTHS: dict[str, python_authorities] = {
    account_auth["account_name"]: to_python_authorities(account_auth["authorities"])  # type: ignore[misc, arg-type]
    for account_auth in _ACCOUNT_AUTHS_LIST
}
