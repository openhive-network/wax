...
PRIVATE_KEYS: Final[dict[str, str]] = {
    "owner": "5Kcb526wim2obMPFQVJcAVbtkWJkFYo746afCLU5cMGttD9cYGw",  # tt.PrivateKey(ACCOUNT, secret="owner"),
    "active": "5Jj2jixMhsR2R1oriWchsQYimH1XyGo4N9s6iB7J3uHyNeq3Ge5",  # tt.PrivateKey(ACCOUNT, secret="active"),
    "posting": "5JhEUJADWcRq3rEP7eWxAHmd8yrigfPhi4DXFPr442AavFEgjXX",  # tt.PrivateKey(ACCOUNT, secret="posting"),
    "memo": "5KZEKVcSF1t2JhbZHNm1PQ3yoxDxRJGK9UWTQdeZw136vXpHTsj",  # tt.PrivateKey(ACCOUNT, secret="memo"),
}
...
PUBLIC_KEYS: Final[dict[str, str]] = {
    "owner": "STM5v3682EzJbJmxUiACzLdtNP3AYYYSATC5AszYpb2Ve3riBnevN",  # tt.PublicKey(ACCOUNT, secret="owner"),
    "active": "STM7599MhAJN4hkBLp7JHvqMVRMb9X1rnfpbc23LJs7HjQgkAi7ea",  # tt.PublicKey(ACCOUNT, secret="active"),
    "posting": "STM5h6ivYuxwA6KTQYHBoZihbou8MsjahP4CgtmG5owtpxQYeyyh3",  # tt.PublicKey(ACCOUNT, secret="posting"),
    "memo": "STM65g4T6xwpy9tE8PeQaBfqgpWXUHshUjSTpnu2MwUiftdbZ8c3x",  # tt.PublicKey(ACCOUNT, secret="memo"),
}

OTHER_ACCOUNT: Final[str] = "bob"

IMPORTED_PRIVATE_KEY: Final[str] = "5JZhZRpYjWYm3jKsz5JEpPDG38Dn9JzhXTFg7gwrpgiLVKuH13B"  # tt.PrivateKey(OTHER_ACCOUNT, secret="active")

IMPORTED_PUBLIC_KEY: Final[str] = "STM8fZEprWbZPauKhypTWsaZunyzhVpauB6xkUJZJXVEvkNzpS2ue"  # tt.PublicKey(OTHER_ACCOUNT, secret="active")
