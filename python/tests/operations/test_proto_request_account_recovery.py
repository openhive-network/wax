...
def test_request_account_recovery():
    ...
    request_account_recovery_proto: request_account_recovery = request_account_recovery(
        recovery_account="account", account_to_recover="account1", new_owner_authority=authority_proto, extensions=[]
    )
    ...
    transaction_proto: transaction = transaction(operations=[request_account_recovery_operation])
