...
rust_protocol::cpp_create_operation_handle(::rust::Box<RustManagedObject> obj) const
{
...
rust_protocol::cpp_create_transaction_handle(::rust::Box<RustManagedObject> obj) const
{
...
void rust_protocol::cpp_tx_add_operation(hive_transaction_handle& tx,
