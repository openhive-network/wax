...
use crate::models::manabar_data::ManabarData;
use crate::models::manabar_data::ManabarType;
use crate::{Transaction, WaxError};
...
mod tests {
    ...
    async fn generated_probe_registers_with_the_health_checker() {
        ...
        let checker = crate::healthchecker::HealthChecker::new();
        ...
        assert_eq!(
            handle.api_caller_id(),
            crate::healthchecker::ChainApiType::JsonRpc
        );
