...
use crate::core::ffi::{hive_operation_handle, rust_protocol};
use crate::core::managed_object::RustManagedObject;
use crate::core::proto::{self, operation::Value};
...
fn create_handle(
    ...
    protocol
        .cpp_create_operation_handle(
            RustManagedObject::from_operation(op),
            true,
        )
