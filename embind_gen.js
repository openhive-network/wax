...
var LibraryEmbind = {
  ...
  $transform_TSFunctionName_deps: [],
  $transform_TSFunctionName: (name) => {
  ...
  $createFunctionDefinition__deps: ['$FunctionDefinition', '$heap32VectorToArray', '$readLatin1String', '$Argument', '$whenDependentTypesAreResolved', '$getFunctionName', '$transform_TSFunctionName', '$getFunctionArgsName', '$PointerDefinition', '$ClassDefinition'],
  $createFunctionDefinition: (name, argCount, rawArgTypesAddr, functionIndex, hasThis, isAsync, cb) => {
    ...
    whenDependentTypesAreResolved([], argTypes, function (argTypes) {
      ...
      name = transform_TSFunctionName(name);
