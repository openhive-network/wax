...
test.describe('WASM Protocol benchmarks', () => {
  test.beforeAll(async () => {
    ...
    transaction = JSON.stringify(new chain.Transaction("04c1c7a566fc0da66aee465714acee7346b48ac2", "2023-08-01T15:38:48").pushOperation(specificBenchmarkTransaction).transaction);
  });
