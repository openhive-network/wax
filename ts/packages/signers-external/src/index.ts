export { ExternalSignatureProvider, ExternalWalletSigner, type IWalletLoadResult, type TPublicKeyInfo, AStorageProviderBase } from "./external-signature-provider.js";
