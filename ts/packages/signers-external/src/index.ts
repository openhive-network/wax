export { ExternalSignatureProvider, ExternalWalletSigner, type IWalletLoadResult, type IWalletInfo, AStorageProviderBase } from "./external-signature-provider.js";
