...
std::shared_ptr<cpp::hive_transaction_handle> cpp_create_transaction_handle(emscripten::val emval, bool is_protobuf, bool is_legacy)const;
std::shared_ptr<cpp::hive_operation_handle> cpp_create_operation_handle(emscripten::val emval, bool is_protobuf, bool is_legacy)const;
...
void cpp_tx_proto_to_api(emscripten::val emval, bool is_legacy)const;
void cpp_tx_api_to_proto(emscripten::val emval, bool is_legacy)const;
};
