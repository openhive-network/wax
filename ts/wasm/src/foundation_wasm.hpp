...
cpp::hive_transaction_handle cpp_create_transaction_handle(emscripten::val emval, bool is_protobuf)const;
cpp::hive_operation_handle cpp_create_operation_handle(emscripten::val emval, bool is_protobuf)const;
