...
export interface IWaxBaseInterface {
   ...
   * @param {number | string | bigint} maxMana maximum account mana. Should equal post_voting_power.amount from the find_account API call for upvotes.
   ...
   * @param {number | string | bigint} currentMana current account mana. Should equal voting_manabar.current_mana from the find_account API call for upvotes or downvote_manabar.current_mana for downvotes
