...
export class ResourceCreditsOperation extends HiveAppsOperation<ResourceCreditsOperation> {
   ...
   * @param {string | number | bigint} maxRc maximum resource credits delegated (must pe non-negative value)
   ...
   */
  public delegate(workingAccount: TAccountName, maxRc: string | number | bigint, delegatee: TAccountName, ...otherDelegatees: TAccountName[]): ResourceCreditsOperation {
