...
export interface IWaxExtendableFormatter extends IWaxFormatter {
   ...
   *
   * @param {string | number | BigInt | bigint} amount number to be formatted
   ...
   */
  formatNumber(amount: string | number | BigInt | bigint, precision?: number, locales?: string | string[]): string;
}
