...
export declare const failed_recurrent_transfer: {
    encode(message: failed_recurrent_transfer, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): failed_recurrent_transfer;
