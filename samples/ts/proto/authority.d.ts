...
export declare const authority: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): authority;
...
export declare const authority_AccountAuthsEntry: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): authority_AccountAuthsEntry;
...
export declare const authority_KeyAuthsEntry: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): authority_KeyAuthsEntry;
