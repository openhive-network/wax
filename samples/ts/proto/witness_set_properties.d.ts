...
export declare const witness_set_properties: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): witness_set_properties;
...
export declare const witness_set_properties_PropsEntry: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): witness_set_properties_PropsEntry;
