...
from wax.proto import account_witness_proxy_pb2, transaction_pb2
...
def test_account_witness_proxy():
    ...
    account_witness_proxy_operation: transaction_pb2.operation = (
        transaction_pb2.operation(account_witness_proxy=account_witness_proxy)
    )
